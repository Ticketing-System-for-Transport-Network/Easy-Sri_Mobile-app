                ...
                <View style={{padding:10}}>
                    <View style={styles.formInput}>
                        <View style={{justifyContent:'center',alignItems:'center'}}>
                            <Image source={require('./assets/images/paysuc.png')} resizeMode={'contain'} style={{width:'100%',   marginTop:70, marginBottom:40,height:300}}/>
                        </View>
                        <View style={styles.container}>
          <Text style={styles.myTitle}>Payment Successful</Text>
        </View>
           </View>
           <View style={styles.container}>
          <Text style={styles.myTitle2}>Payment ID : 0000000</Text>
        </View>
                                 <View style={styles.formInput}>
