                ...
                <View style={{padding:10}}>
                    <View style={styles.formInput}>
                        <View style={{justifyContent:'center',alignItems:'center'}}>
                            <Image source={require('./assets/images/Suc.jpg')} resizeMode={'contain'} style={{width:'100%',   marginTop:70, marginBottom:40,height:300}}/>
                        </View>
                        <View style={styles.container}>
          <Text style={styles.myTitle}>Successfully Scan!</Text>
        </View>
        <View style={styles.container}>
          <Text style={styles.myTitle2}>Start:Kaluthara</Text>
        </View>
                    </View>
                                 <View style={styles.formInput}>
